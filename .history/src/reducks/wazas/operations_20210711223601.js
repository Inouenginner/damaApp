...
export const signIn = (name) => {
    return async (dispatch, getState) => {
        ...
        const userStandardRef = db.collection('users').where("name", "==", name)
        ...
        if (userDoc.exists) {
            ...
            userInit(userStandardRef, name, id);
        }
        fetchWazas(userStandardRef, name, id);
    }
}

export const userInit = (userRef, name, nextId) => {
    return async (dispatch, getState) => {
        ...
        console.log("userDB input start")
            ...
            const detailsRef = db.collection('details').doc(nextId)
